/**
 * Gallery detail carousels (infinite loop): #Surveillancecore (face-track → …),
 * The Weather Room (colour rectangle → photos), dollhouse (several images; #sketch opens on the ink
 * sketch slide). Clone last slide
 * before first and first after last so wrap always animates one step, then the track jumps
 * invisibly to the real slide.
 */
(function () {
